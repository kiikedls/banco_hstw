...
--  Buro
insert into buro values (1,'2019-12-12','HSBC',1,'pago adecuado');
insert into buro values (2,'2018-11-22','BANCOMER',3,'pago insatisfactorio');
insert into buro values (3,'2017-01-10','BANAMEX',2,'Pago debil');
