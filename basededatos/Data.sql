...
insert into pagos values (5,20,'2019-11-22', NULL, 3500,8,0,180000,5);
--  tipo tarjeta
...
--  Buro
insert into buro values (1,'2019-12-12','HSBC',1,'pago adecuado','pfe98676');
insert into buro values (2,'2018-11-22','BANCOMER',3,'pago insatisfactorio','scj98676');
insert into buro values (3,'2017-01-10','BANAMEX',2,'Pago debil','lgc98676');
insert into buro values (4,'2019-05-20','SCOTIABANK',3,'pago adecuado','GDA98676');
insert into buro values (5,'2018-06-12','BANCOMER',3,'pago satisfactorio','RJS98676');
-- registros_buro
