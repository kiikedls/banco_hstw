...
@section('content')
    ...
    <form method="POST" class="text-center border  border-light p-5" action="/actualizar">
        @csrf
        <center>
            <div class="modal-body mx-3 modal-inputs a">
                ...
                @foreach($cc as $datos)
                    ...
                    <div class="md-form mb-5">
                        <input type="text" name="nom" value="{{$datos->nom}}" id="inputName151" class="form-control validate" >
                        <label data-error="wrong" data-success="right" for="inputName151">Nombre</label>
                    </div>
                    <div class="form-row md-form mb-5">
                        <div class="col">
                            <input type="text" name="apeP" value="{{$datos->apeP}}" id="inputPosition151" class="form-control validate">
                            <label data-error="wrong" data-success="right" for="inputPosition151">Apellido Paterno</label>
                        </div>
                        <div class="col">
                            <input type="text" name="apeM" value="{{$datos->apeM}}" id="inputPosition181" class="form-control validate">
                            <label data-error="wrong" data-success="right" for="inputPosition181">Apellido Materno</label>
                        </div>
                    </div>
                    <div class="md-form mb-5">
                        <input type="date" name="f_nac" value="{{$datos->f_nac}}" id="inputDate151" class="form-control" placeholder="Select Date">
                        <label data-error="wrong" data-success="right" for="inputDate151">Fecha de Nacimiento</label>
                    </div>
                    <div class="md-form mb-5">
                        <input type="text" name="CURP" value="{{$datos->CURP}}" id="inputOfficeInput151" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="inputOfficeInput151">CURP</label>
                    </div>
                    <div class="md-form mb-5">
                        <input type="text" name="RFC" value="{{$datos->RFC}}" id="inputAge154" class="form-control validate">
                    ...
                    <div class="md-form mb-5">
                        <input type="text" name="calle" value="{{$datos['direcciones'][0]->calle}}" id="inputDir125" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="inputDir125">Calle</label>
                    </div>
                    <div class="md-form mb-5">
                        <input type="text" name="colonia" value="{{$datos['direcciones'][0]->colonia}}" id="inputcOL1" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="inputcOL1">Colonía</label>
                    </div>
                    <div class="form-row md-form mb-4">
                        <div class="col">
                            <input type="text" name="num_int" value="{{$datos['direcciones'][0]->num_int}}" id="inputNint2" class="form-control validate">
                            <label data-error="wrong" data-success="right" for="inputNint2">Número Interior</label>
                        </div>
                        <div class="col">
                            <input type="text" name="num_ext" value="{{$datos['direcciones'][0]->num_ext}}" id="inputNext4" class="form-control validate">
                            <label data-error="wrong" data-success="right" for="inputNext4">Número Exterior</label>
                        </div>
                    </div>
                    <div class="md-form mb-5">
                        <input type="text" name="calles" value="{{$datos['direcciones'][0]->calles}}" id="inputcalles" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="inputcalles">Calles</label>
                    </div>
                    <div class="md-form mb-5">
                        <input type="text" name="cp" value="{{$datos['direcciones'][0]->cp}}" id="inputcp1" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="inputcp1">Código Postal</label>
                    </div>
                    <div class="md-form mb-5">
                        <input type="text" name="ciudad"  value="{{$datos['direcciones'][0]->ciudad}}" id="inputciudad1" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="inputciudad1">Ciudad </label>
                    </div>
                    <div class="md-form mb-5">
                        <input type="text" name="estado" value="{{$datos['direcciones'][0]->estado}}" id="inputedo" class="form-control validate">
                        <label data-error="wrong" data-success="right" for="inputedo">Estado</label>
                    </div>
                    <div class="md-form mb-5">
                        <input type="text" name="pais" value="{{$datos['direcciones'][0]->pais}}" id="inputpais1" class="form-control validate">
